...
def build_consulta_context(args: dict) -> dict:
    ...
    limite = CONSULTA_LIMIT_MAX if filters["limite"] in ("0", "todo") else parse_int_filter(filters["limite"], "Límite", errors, 1, CONSULTA_LIMIT_MAX) or CONSULTA_LIMIT_DEFAULT
