...
from motores.constants import VENDEDOR_LOCAL, METODO_EFECTIVO, ESTADO_SEPARADA
...
def register_routes(app):
    ...
    def nueva_factura_cliente():
        ...
        if request.method == "POST":
            ...
            form = {"nombre": nombre, "telefono": telefono, "direccion": direccion}
            ...
            if errors:
                for e in errors:
                    flash(e, "danger")
                return render_template("nueva_factura_cliente.html", form=form, today=today)
